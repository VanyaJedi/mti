...
import { isMobileServer } from "@/features/device-detector/deviceDetector.server";
...
import { GalleryTabs } from "@/features/gallery-tabs";
...
export default async function Home() {
  ...
  return (
    <div className={s.page}>
      <main>
        <div className={s.headSectionWrapper}>
        ...
        <Section className={s.gallerytTabs}>
          <GalleryTabs />
        </Section>
      </main>
    </div>
